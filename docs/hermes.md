...
For BC MCP tools, you may keep approval UX in your ops platform and still evaluate here (or evaluate only in BC for Path 2). Pick **one** PEP per executor path — never fail-open.
